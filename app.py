...
def process_inputs():
    try:
        ...
        with open(f"./{inputDir}/input_file.txt", "w") as file:
            file.write(input_text.get("1.0", "end-1c"))
            
        with open(f"./{resultsDir}/results_file.txt", "w") as file:
            pass
        ...
        if process.returncode == 0:
            ...
            with open(resultsDir + results_file_path, "r") as file:
